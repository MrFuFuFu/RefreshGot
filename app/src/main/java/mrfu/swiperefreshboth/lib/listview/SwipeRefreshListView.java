package mrfu.swiperefreshboth.lib.listview;
 ...
 * mListView.addFooterView(mSwipeLayout.mListViewFooter);//一定要先添加一次，不然会报错，setAdapter 之后 remove 掉   看这里：http://blog.csdn.net/Take_all/article/details/7635116
 * mListView.setAdapter(arrayAdapter);
 * mListView.removeFooterView(mSwipeLayout.mListViewFooter);
 * mSwipeLayout.setOnPullRefreshListener(this);
 *
 * stop refresh: mSwipeLayout.refreshReset();
 * Created by MrFu on 15/6/12.
 */
public class SwipeRefreshListView extends SwipeRefreshLayout implements OnScrollListener {
